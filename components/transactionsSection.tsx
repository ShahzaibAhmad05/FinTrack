...
export default function TransactionsSection(
  { transactions, handleRemoveTransaction, handleEditTransaction }: TransactionsSectionProps
) {
    ...
    <div className="flex flex-col gap-5">
      ...
      <div className="flex flex-col gap-6 mx-1">
        {transactions.map((transaction) => (
          <div 
            className="flex flex-col lg:flex-row bg-white border border-black rounded-2xl px-4 sm:px-6 py-3 gap-2 shadow-[4px_4px_0_black]" 
            key={transaction.id}
          >
            <div className="flex flex-col my-2 lg:w-[30%]">
              ...
              <div className="">
                <span 
                  className={`${categoryTextColorMap[transaction.category]} text-3xl sm:text-4xl font-bold font-mono`}
                >
            ...
            <div className="my-2 lg:mx-12">
              <span className="text-gray-700">
                {transaction.description}
              </span>
            </div>
            <div className="flex flex-row lg:flex-col gap-2 my-2 lg:ml-auto">
              <button
